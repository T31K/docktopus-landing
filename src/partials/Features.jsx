...
import Feature3 from '../images/features_3.svg';
        ...
        <div className="pt-12 md:pt-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            ...
            <p className="text-xl text-gray-600">
              Maximize your screen real estate with <span className="font-semibold">Docktopus</span> <br /> seamless
              integration with the macOS dock.
            </p>
          </div>
          ...
          <div className="md:grid md:grid-cols-12 md:gap-6">
            ...
            >
              ...
              <div className="mb-8 md:mb-0">
                <a
                  className={`flex items-center text-lg p-5 h-[120px] rounded-xl border transition duration-300 ease-in-out mb-3 justify-between ${
                ...
                >
                  <div>
                    <div className="font-bold leading-snug tracking-tight mb-1">
                      Seamlessly integrate with your dock
                    </div>
