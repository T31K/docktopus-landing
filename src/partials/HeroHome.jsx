      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="pt-20 pb-12 md:pt-25 md:pb-20">
          ...
          <div className="text-center">
            <h1 className="text-5xl md:text-6xl font-extrabold leading-tighter tracking-tighter mb-4" data-aos="zoom-y-out">Sleek. Convenient. <br/><span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-[#FFFFb0]">Music at your fingertips</span></h1>
